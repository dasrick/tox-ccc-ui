...
describe('Components:Security:Directive:HasType', function () {
  ...
  it('should set hasType to true', angular.mock.inject(function ($compile, $rootScope) {
  ...
  it('should set hasType to false', angular.mock.inject(function ($compile, $rootScope) {
  ...
  it('should set hasType to false for admin and true for other', angular.mock.inject(function ($compile, $rootScope) {
    var button;
